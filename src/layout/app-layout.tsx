...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'teacher', 'student', 'staff'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Staff', path: '/staff', entity: 'staff', service: AccessServiceEnum.PROJECT, icon: FiUserX },
    { name: 'Students', path: '/students', entity: 'student', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Teachers', path: '/teachers', entity: 'teacher', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
