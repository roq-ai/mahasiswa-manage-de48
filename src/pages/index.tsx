  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Mahasiswa Management, your ultimate platform for seamless student management. We build, you grow, together we empower education."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1671726203454-5d7a5370a9f4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxzdHVkZW50fGVufDB8fHx8MTY5NzEzNzc1NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Mahasiswa Management, your ultimate platform for seamless student management. We build, you grow, together we empower education.`}
            </Text>
            <Box
